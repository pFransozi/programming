...
/*
After seggregated some responsabilities, remain other:

1. auto-incremental ID is still exposed publicly, leaking the
responsability to the comsumer.
2. the save method handles with two responsabilities: update
and add.
